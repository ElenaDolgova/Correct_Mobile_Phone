...
function validateFIO(elems) {
    var fioArray = elems.fio.value.match(/\s[a-zA-ZА-Яа-я]/g);
...
function validateEmail(elems) {
    var myPattern = /^[-a-zA-Z0-9!#$%&'*+/=?^_`{|}~]+(\.[-a-zA-Z0-9!#$%&'*+/=?^_`{|}~]+)*@(ya.ru|yandex.ru|yandex.ua|yandex.ua|yandex.kz|yandex.com)$/;
